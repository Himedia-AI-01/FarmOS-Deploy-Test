...
jq -r '
    def name_map(n):
      ...
      elif n == "/farmos/prod/cookie/domain"                then "COOKIE_DOMAIN"
      elif n == "/farmos/prod/cookie/secure"                then "COOKIE_SECURE"
      elif n == "/farmos/prod/cookie/samesite"              then "COOKIE_SAMESITE"
